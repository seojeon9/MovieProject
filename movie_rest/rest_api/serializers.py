...
class MovieCompanySerializer(serializers.HyperlinkedModelSerializer):
...
class MovieAudiSerializer(serializers.HyperlinkedModelSerializer):
...
class MovieHitSerializer(serializers.HyperlinkedModelSerializer):
...
class MovieRankSerializer(serializers.HyperlinkedModelSerializer):
...
class MovieSalesSerializer(serializers.HyperlinkedModelSerializer):
...
class MovieScoreSerializer(serializers.HyperlinkedModelSerializer):
...
class MovieScrnSerializer(serializers.HyperlinkedModelSerializer):

    class Meta:
        model = MovieScrn
        fields = ['scrn_id', 'movie_code', 'movie_name', 'hit_grade']


class MovieSearchSerializer(serializers.HyperlinkedModelSerializer):
